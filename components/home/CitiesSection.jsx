...
export default function CitiesSection() {
  ...
  if (!cities.length) return <section className="curated-collection-section"><div className="curated-empty-state"><FaMapMarkerAlt /><strong>{uiT("noDestinations")}</strong><span>{commonT("checkBackSoon", { defaultValue: "Please check back soon for new experiences." })}</span></div></section>;
