...
export const metadata = {
  title: {
    ar: "اتصل بنا – Basttet Travel في الأقصر، مصر",
    en: "Contact Basttet Travel – Luxor, Egypt",
    de: "Kontakt Basttet Travel – Luxor, Ägypten",
    es: "Contacto Basttet Travel – Luxor, Egipto",
    fr: "Contactez Basttet Travel – Louxor, Égypte",
    it: "Contatta Basttet Travel – Luxor, Egitto",
    zh: "联系我们 – Basttet Travel 卢克索, 埃及",
  },
  description: {
    ar: "تواصل معنا للاستفسارات أو الحجز أو إعداد برامج سفر شخصية.",
    en: "Get in touch with Basttet Travel for inquiries, bookings, or personalized itineraries.",
    de: "Kontaktieren Sie Basttet Travel für Anfragen, Buchungen oder individuelle Reisepläne.",
    es: "Contáctanos para consultas, reservas o itinerarios personalizados.",
    fr: "Contactez Basttet Travel pour des demandes, des réservations ou des itinéraires personnalisés.",
    it: "Contatta Basttet Travel per richieste, prenotazioni o itinerari personalizzati.",
    zh: "如有咨询、预订或个性化行程，请与 Basttet Travel 联系。",
  },
  keywords: {
    ar: "اتصل بنا, Basttet Travel, وكالة سفر مصر, رحلات الأقصر",
    en: "Contact Basttet Travel, Egypt travel agency, Luxor tours",
    de: "Kontakt Basttet Travel, Ägypten Reisebüro, Luxor Touren",
    es: "Contacto Basttet Travel, Agencia de viajes Egipto, Tours Luxor",
    fr: "Contact Basttet Travel, Agence de voyages Égypte, Tours Louxor",
    it: "Contatta Basttet Travel, Agenzia viaggi Egitto, Tour Luxor",
    zh: "联系我们, Basttet Travel, 埃及旅行社, 卢克索旅游",
  },
};
