...
const fallbackMetadata = {
  ...
  description:
    "Discover luxury Nile cruises, desert adventures and unforgettable Egypt tours with Basttet Travel.",
  keywords: "Egypt tours, Nile cruises, Luxor tours, desert safaris",
};
